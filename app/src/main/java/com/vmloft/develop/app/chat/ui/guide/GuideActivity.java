package com.vmloft.develop.app.chat.ui.guide;
...
public class GuideActivity extends AppActivity {
    ...
    protected void init() {
        mBGColors = new int[]{
                VMColor.colorByResId(R.color.app_guide_bg_0),
                VMColor.colorByResId(R.color.app_guide_bg_1),
                VMColor.colorByResId(R.color.app_guide_bg_2)
        };

        mFragmentList = new ArrayList<>();
        mFragmentList.add(GuideFragment.newInstance(R.drawable.image_default, R.string.guide_title_0, R.string.guide_intro_0));
        mFragmentList.add(GuideFragment.newInstance(R.drawable.image_default, R.string.guide_title_1, R.string.guide_intro_1));
        mFragmentList.add(GuideFragment.newInstance(R.drawable.image_default, R.string.guide_title_2, R.string.guide_intro_2));
