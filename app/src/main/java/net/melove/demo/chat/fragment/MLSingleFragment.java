 ...
 * 单聊模块儿 Fragment
 */
public class MLSingleFragment extends MLBaseFragment {
     ...
     */
    public static MLSingleFragment newInstance(String param1, String param2) {
        MLSingleFragment fragment = new MLSingleFragment();
