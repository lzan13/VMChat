 ...
 * 聊天室模块儿 Fragment
 */
public class MLRoomFragment extends MLBaseFragment {
     ...
     * @param param1
     * @param param2
     * @return MLRoomFragment
     */
    public static MLRoomFragment newInstance(String param1, String param2) {
        MLRoomFragment fragment = new MLRoomFragment();
