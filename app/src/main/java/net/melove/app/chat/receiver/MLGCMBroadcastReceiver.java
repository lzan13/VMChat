package net.melove.app.chat.receiver;
...
public class MLGCMBroadcastReceiver extends BroadcastReceiver {
    ...
    public void sendNotification(Context context, String message, boolean isForeground) {
        ...
        try {
            ...
            String appname =
                    (String) packageManager.getApplicationLabel(context.getApplicationInfo());

            // notification titile
            String contentTitle = appname;
            String packageName = context.getApplicationInfo().packageName;

            Uri defaultSoundUrlUri =
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity(context, notifyID, msgIntent,
