...
import net.melove.app.chat.ui.setting.MLSettingsActivity;
...
public class MLMainActivity extends MLBaseActivity
    ...
    private void initView() {
        ...
        getToolbar().setTitle(mActivity.getResources().getString(R.string.ml_chat));
     ...
     * @param a action命令
     */
    @Override public void onFragmentClick(int a, int b, String s) {
        Intent intent = null;
        int w = a | b;
        switch (w) {
            // 0x0x 表示系统级调用
