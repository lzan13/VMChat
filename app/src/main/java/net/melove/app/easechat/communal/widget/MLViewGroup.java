package net.melove.app.easechat.communal.widget;
 ...
 */
public class MLViewGroup extends ViewGroup {

    private final int HORIZONTAL_SPACE = 2;
    private final int VERTICAL_SPACE = 2;

    public MLViewGroup(Context context) {
        super(context);
    }

    public MLViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
